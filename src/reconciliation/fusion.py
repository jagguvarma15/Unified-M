...
class ReconciliationEngine:
    ...
    def _detect_channels(self) -> list[str]:
        ...
        if (
            self._incrementality_tests is not None
            and "channel" in self._incrementality_tests.columns
        ):
...
def weighted_average_fusion(
    ...
    for channel in channels:
        ...
        if incrementality_tests is not None:
            channel_tests = incrementality_tests[incrementality_tests["channel"] == channel]
        ...
        if attribution_data is not None:
            channel_attr = attribution_data[attribution_data["channel"] == channel]
