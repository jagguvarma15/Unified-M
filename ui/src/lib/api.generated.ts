...
export interface paths {
  ...
  "/api/v1/contributions": {
    get: JsonBody<{ data: Record<string, unknown>[]; n_rows?: number }>;
  };
  ...
  "/api/v1/response-curves": {
    get: JsonBody<
      Record<
        string,
        { spend?: number[]; response?: number[]; marginal_response?: number[] }
      >
    >;
  };
  "/api/v1/parameters": {
    get: JsonBody<{
      ...
      adstock_params?: Record<string, unknown>;
      saturation_params?: Record<string, unknown>;
    }>;
  };
  "/api/v1/diagnostics": {
    get: JsonBody<{
  ...
  "/api/v1/pipeline/run": {
    post: JsonBody<{ job_id: string; status: string }>;
  };
  ...
  "/api/v1/connectors/{connector_id}/test": {
    post: JsonBody<{ status: string; connected: boolean; message: string }>;
  };
  "/api/v1/connectors/{connector_id}/fetch": {
    post: JsonBody<{
      status: string;
      rows: number;
      columns: string[];
