    ...
    >
      <Show when={data()} fallback={<EmptyState />}>
        {() => {
          ...
          const allVals = [...scatterData.map((x) => x.actual), ...scatterData.map((x) => x.predicted)];
          ...
          return (
            <div>
              <h1 class="text-2xl font-bold text-slate-900">Model Diagnostics</h1>
              ...
              <div class={`mt-4 flex items-center gap-2 px-4 py-2.5 rounded-lg text-sm font-medium ${
                  ...
                  <div class="space-y-3">
                    ...
                    <div class="space-y-2 text-sm">
                      <div class="flex justify-between">
                        ...
                        <span class="font-mono font-medium">{(d.residual_stats?.mean ?? 0).toFixed(2)}</span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-slate-500">Std Dev</span>
                        <span class="font-mono font-medium">{(d.residual_stats?.std ?? 0).toFixed(2)}</span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-slate-500">Min</span>
                        <span class="font-mono font-medium">{(d.residual_stats?.min ?? 0).toFixed(2)}</span>
                      </div>
                      <div class="flex justify-between">
                        <span class="text-slate-500">Max</span>
                        <span class="font-mono font-medium">{(d.residual_stats?.max ?? 0).toFixed(2)}</span>
                      </div>
                    </div>
