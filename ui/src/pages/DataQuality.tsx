        ...
        <Show when={data()} fallback={
          ...
          {() => (
            <div class="min-h-[60vh] space-y-6">
              ...
              >
                <Show when={data()!.overall_pass} fallback={<XCircle class="w-8 h-8 text-red-600" />}>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <MetricCard icon={CheckCircle} label="Passed" value={data()!.n_passed ?? 0} />
                <MetricCard icon={AlertTriangle} label="Warnings" value={data()!.n_warnings ?? 0} />
                <MetricCard icon={XCircle} label="Failed" value={data()!.n_failed ?? 0} />
              </div>
                    ...
                    return (
                      <div>
                        <button
                          ...
                          onClick={() => setExpanded(expanded() === gateKey ? null : gateKey)}
                        >
                          <div class="flex items-center gap-3">
                            ...
                            <div class="text-left">
                              ...
                              <p class="text-xs text-gray-500">{gate.message}</p>
                            </div>
                          </div>
